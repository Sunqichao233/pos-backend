...
└─────────────────────────────────────────────────────────────────────────────┘
    ...
    Device (设备)                  TaxRule (税务规则)           Notification (通知)
┌─────────────────┐              ┌─────────────────┐           ┌─────────────────┐
│ device_id (PK)  │              │ tax_rule_id(PK) │           │notification_id  │
│ store_id (FK)   │              │ store_id (FK)   │           │ (PK)            │
│ device_name     │              │ tax_name        │           │ store_id (FK)   │
│ device_type     │              │ tax_rate        │           │ user_id (FK)    │
│ mac_address     │              │ tax_type        │           │ title           │
│ ip_address      │              │ applicable_to   │           │ message         │
│ last_online     │              │ effective_from  │           │ type            │
│ status          │              │ effective_until │           │ is_read         │
│ registered_at   │              │ is_active       │           │ created_at      │
│ created_at      │              │ created_at      │           │ updated_at      │
│ updated_at      │              │ updated_at      │           │ created_by      │
│ created_by      │              │ created_by      │           │ updated_by      │
│ updated_by      │              │ updated_by      │           │ read_at         │
